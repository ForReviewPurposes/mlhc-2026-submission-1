CREATE OR REPLACE TABLE `eicu-ext.eicu_ext_data.eicu_signal_24h_agg_wide` AS
SELECT
...
FROM `eicu-ext.eicu_ext_data.eicu_signal_24h_agg_long`
GROUP BY patientunitstayid, hospitalid, mortality, gender, anchor_age, duration_hours_from_24h,
event_after_24h;